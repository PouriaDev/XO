...
";
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "ارتقا ربات به V.I.P 🌟

- امکانات فوق پیشرفته 🅰
- قابلیت عوض کردن ایدی کانال سازنده 🖊
- حذف تبلیغات ما از ربات شما 📝
- قابلیت ارسال پیام همگانی 📨
- قابلیت تغییر متن استارت 📝
